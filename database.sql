...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=728594601ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gallery&table=image">`gallery`.`image`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=store_abc&table=orders">`store_abc`.`orders`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3f2a3126282458642f76592841675e7e">
...
CREATE TABLE `orders` (
  ...
  `Cashier` varchar(1) NOT NULL,
  `Price` decimal(6,2) DEFAULT NULL,
  `Date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="store_abc" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="store_abc" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` WHERE Cashier = &#039;$selectedOption&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store_abc" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` WHERE Cashier = &quot;A&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="store_abc" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` WHERE Cashier = &#039;A&#039;;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="gallery" targettable="image">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `gallery`.`image` ( `ID` INT(10) NOT NULL AUTO_INCREMENT ,  `filename` VARCHAR(500) NOT NULL ,    PRIMARY KEY  (`ID`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gallery" targettable="image">
                            <div class="action_content">
